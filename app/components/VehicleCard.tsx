    ...
    <article className="mx-auto flex h-full w-full max-w-sm flex-col overflow-hidden rounded-xl border border-[#292d35] bg-[#111318] transition hover:border-[#665714]">
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <div className="mt-auto flex items-center justify-between pt-6">
          <p className="text-sm font-bold text-[#ffd015]">{price}<span className="text-[10px] font-normal text-[#858994]">{rateUnit}</span></p>
          <a href="#details" className="inline-flex items-center rounded-md bg-[#ffd015] px-3 py-2 text-[10px] font-bold text-[#151515] hover:bg-[#ffe05b]">Details</a>
        </div>
      </div>
    </article>
  );
